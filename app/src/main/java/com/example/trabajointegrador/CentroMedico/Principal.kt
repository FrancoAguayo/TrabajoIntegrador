...
fun main() {
    ...
    var paciente2 = Paciente("Daniel","Hernandez",34,45272572,56.8,1.54,"bronquiolitis")
    ...
    cirujano1.cirugia()
    tratamiento1.tratamiento("Reposo",3,true)
    tratamiento2.tratamiento("Farmacoterapia",5,4)
}